...
[CreateAssetMenu(menuName = "State/PlayerState/CastFireBall", fileName = "PlayerCastFireBall")]
public class PlayerStateCastFireBall : PlayerState
{
    private float originGravity;
    private float castDuration = 2f;// 施法持续时间
